...
public class DOSale {
    public static void main(String args[]) {
        ...
        UserInfo user = new UserInfo("granicus", "granicusepaymicro", "paypal", "5QMtukJnn8k12");
        //UserInfo user = new UserInfo("EcomVBAPI", "EcomVB", "paypal", "OnO9VoPLTXcKVbW37jm8");
       ...
       /* EcomVBMicroAPI
        ...
        oZhKCplw9NgqkXh8NQsk
        OnO9VoPLTXcKVbW37jm8
        O<4ILg0b*/
        ...
        bill.setStreet("2341 Dulles Station Blvd Apt 6");
        bill.setCity("Herndon");
        bill.setState("VA");
        bill.setZip("20171");
        inv.setBillTo(bill);
        ...
        //CreditCard cc = new CreditCard("4400660978263050", "0317");
        CreditCard cc = new CreditCard("4111111111111111", "1017");
        cc.setCvv2("453");
