...
VALUES ('COMAL-OTC', 'Rockwall County OTC', 'Y', 'Rockwall', 'TX', 'Y', 'America/Chicago', @NODE_ID, GETDATE(), GETDATE(), 
'SYSTEM', '', 'Y', 'Y', 'Rockwall County', 'SYSTEM', 3, 30, 30, 3, 'N', 'N', 'N', 'N', 'N')
GO


--- INSERT MERCHANT INFORMATION ---
DECLARE @SITE_ID AS INT = (SELECT TOP 1 ID FROM ECOMM_SITE WHERE NAME = 'COMAL-OTC')
...
--- INSERT BANK DETAILS FOR COMAL-OTC ---
